...
function $db6c3485150b8e66$export$1ab7ae714698c4b8(element) {
  const [size, setSize] = (0, import_react8.useState)(void 0);
...
var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = (0, import_react9.forwardRef)((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    const newChildren = childrenArray.map((child) => {
      if (child === slottable) {
        ...
        return (0, import_react9.isValidElement)(newElement) ? newElement.props.children : null;
      } else
        return child;
    });
    return (0, import_react9.createElement)($5e63c961fc1ce211$var$SlotClone, _extends({}, slotProps, {
      ref: forwardedRef
    }), (0, import_react9.isValidElement)(newElement) ? (0, import_react9.cloneElement)(newElement, void 0, newChildren) : null);
  }
  return (0, import_react9.createElement)($5e63c961fc1ce211$var$SlotClone, _extends({}, slotProps, {
    ref: forwardedRef
  }), children);
...
var $5e63c961fc1ce211$var$SlotClone = (0, import_react9.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d45 = ({ children }) => {
  return (0, import_react9.createElement)(import_react9.Fragment, null, children);
};
function $5e63c961fc1ce211$var$isSlottable(child) {
  return (0, import_react9.isValidElement)(child) && child.type === $5e63c961fc1ce211$export$d9f1ccf0bdb05d45;
}
...
var $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
  const Node = (0, import_react10.forwardRef)((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? $5e63c961fc1ce211$export$8c6ed5c666ac1360 : node;
    (0, import_react10.useEffect)(() => {
      window[Symbol.for("radix-ui")] = true;
    }, []);
    return (0, import_react10.createElement)(Comp, _extends({}, primitiveProps, {
      ref: forwardedRef
    }));
  });
...
function $e02a7d9cb1dc128c$export$c74125a8e3af6bb2(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    return import_react11.default.createElement(CollectionProviderImpl, {
      scope,
      itemMap,
      collectionRef: ref
    }, children);
  ...
  const CollectionSlot = import_react11.default.forwardRef((props, forwardedRef) => {
    const { scope, children } = props;
    const context = useCollectionContext(COLLECTION_SLOT_NAME, scope);
    const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, context.collectionRef);
    return import_react11.default.createElement($5e63c961fc1ce211$export$8c6ed5c666ac1360, {
      ref: composedRefs
    }, children);
  });
  ...
  const CollectionItemSlot = import_react11.default.forwardRef((props, forwardedRef) => {
...
var $faa2e61a3361514f$export$472062a354075cee = (0, import_react12.forwardRef)((props, forwardedRef) => {
  ...
  const [slider, setSlider] = (0, import_react12.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setSlider(node)
  );
  const thumbRefs = (0, import_react12.useRef)(/* @__PURE__ */ new Set());
  const valueIndexToChangeRef = (0, import_react12.useRef)(0);
  ...
  const valuesBeforeSlideStartRef = (0, import_react12.useRef)(values);
  ...
  return (0, import_react12.createElement)($faa2e61a3361514f$var$SliderProvider, {
    ...
    values,
    orientation
  }, (0, import_react12.createElement)($faa2e61a3361514f$var$Collection.Provider, {
    scope: props.__scopeSlider
  }, (0, import_react12.createElement)($faa2e61a3361514f$var$Collection.Slot, {
    scope: props.__scopeSlider
  }, (0, import_react12.createElement)(SliderOrientation, _extends({
    ...
    (value, index) => (0, import_react12.createElement)($faa2e61a3361514f$var$BubbleInput, {
      key: index,
...
var $faa2e61a3361514f$var$SliderHorizontal = (0, import_react12.forwardRef)((props, forwardedRef) => {
  ...
  const rectRef = (0, import_react12.useRef)();
  ...
  return (0, import_react12.createElement)($faa2e61a3361514f$var$SliderOrientationProvider, {
    scope: props.__scopeSlider,
    startEdge: isSlidingFromLeft ? "left" : "right",
    endEdge: isSlidingFromLeft ? "right" : "left",
    direction: isSlidingFromLeft ? 1 : -1,
    size: "width"
  }, (0, import_react12.createElement)($faa2e61a3361514f$var$SliderImpl, _extends({
    dir: direction,
...
var $faa2e61a3361514f$var$SliderVertical = (0, import_react12.forwardRef)((props, forwardedRef) => {
...
var $faa2e61a3361514f$var$SliderImpl = (0, import_react12.forwardRef)((props, forwardedRef) => {
  const { __scopeSlider, onSlideStart, onSlideMove, onSlideEnd, onHomeKeyDown, onEndKeyDown, onStepKeyDown, ...sliderProps } = props;
  const context = $faa2e61a3361514f$var$useSliderContext($faa2e61a3361514f$var$SLIDER_NAME, __scopeSlider);
  return (0, import_react12.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({}, sliderProps, {
    ref: forwardedRef,
...
var $faa2e61a3361514f$export$105594979f116971 = (0, import_react12.forwardRef)((props, forwardedRef) => {
  const { __scopeSlider, ...trackProps } = props;
  const context = $faa2e61a3361514f$var$useSliderContext($faa2e61a3361514f$var$TRACK_NAME, __scopeSlider);
  return (0, import_react12.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({
...
var $faa2e61a3361514f$export$a5cf38a7a000fe77 = (0, import_react12.forwardRef)((props, forwardedRef) => {
...
var $faa2e61a3361514f$export$2c1b491743890dec = (0, import_react12.forwardRef)((props, forwardedRef) => {
  const getItems = $faa2e61a3361514f$var$useCollection(props.__scopeSlider);
  const [thumb, setThumb] = (0, import_react12.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setThumb(node)
  );
  const index = (0, import_react12.useMemo)(
  ...
  return (0, import_react12.createElement)($faa2e61a3361514f$var$SliderThumbImpl, _extends({}, props, {
    ref: composedRefs,
    index
  }));
});
var $faa2e61a3361514f$var$SliderThumbImpl = (0, import_react12.forwardRef)((props, forwardedRef) => {
  ...
  }, (0, import_react12.createElement)($faa2e61a3361514f$var$Collection.ItemSlot, {
    scope: props.__scopeSlider
